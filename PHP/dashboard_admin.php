...
// Si no hay sesión iniciada o el rol no es Administrador, rebota al login por seguridad
...
// Obtener la tasa del dólar actual desde la tabla parametricas
$tasa_dolar = "0.00";
try {
...
<head>
    ...
    <title>Panel Administrativo - Inventario OP</title>
    ...
    <div class="contenedor-sistema">
        ...
        <aside class="barra-lateral">
            ...
            <nav class="menu-navegacion">
                <a href="dashboard_admin.php" class="activo">📊 Dashboard</a>
        ...
        <main class="contenido-principal">
            ...
            <header class="cabecera-superior">
                <div class="titulo-cabecera">
                    <span>Sistema web de inventarios</span>
                </div>
                <div class="perfil-usuario">
                    <span class="badge-tasa">💵 Tasa: <?php echo $tasa_dolar; ?> Bs</span>
                    <span class="usuario-nombre">👤 <?php echo isset($_SESSION['usuario_nombre']) ? $_SESSION['usuario_nombre'] : 'Administrador'; ?> (Admin)</span>
            ...
            <div class="area-trabajo">
                ...
                <div class="grilla-tarjetas">
                    ...
                    <div class="tarjeta-indicador naranja">
                        <div class="icono-tarjeta">🚚</div>
                        <div class="info-tarjeta">
                            <h3>Proveedores</h3>
                            <p class="contador">0</p>
                    ...
                    <div class="tarjeta-indicador morado">
                        <div class="icono-tarjeta">🍎</div>
                        <div class="info-tarjeta">
                            <h3>Productos</h3>
                            <p class="contador">0</p>
                    ...
                    <div class="tarjeta-indicador rosa">
                        <div class="icono-tarjeta">👥</div>
                        <div class="info-tarjeta">
                            <h3>Usuarios</h3>
